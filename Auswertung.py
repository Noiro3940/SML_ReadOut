...
def Stundenverbrauch(Daten,Auswertung,Ausgabe=False):
	...
	for i in range(0,24): #für die Verbrauchsermittlung jeder Stunde
		...
		if getlen1 >= 0:
			...
			if Auswertung == "Heizung": Verbrauch2 = (Zählerwerte2[getlen2]-Zählerwerte2[0])*1000 #Berechnet den Verbrauch für die Stunde
...
def Jahresverbrauch(Fileliste,Verzeichnis,Auswertung, Jahr,Anzeige=False):
    ...
    for Monat in range(1,13):
        Verbrauch,DVerbrauch = Monatsverbrauch_Tagesverbrauchsanzeige(Fileliste,Verzeichnis,Auswertung,Monat,Jahr,False)
...
def main():
    ...
    while True:
        ...
        if Auswahl == 1:
            ...
            Stundenverbrauch(DateiInhalt,Auswertung,anzeigen)
            ...
            os.system('clear')
            Monatsverbrauch_Tagesverbrauchsanzeige(FileListe,Verzeichnis,Auswertung,Monat,Jahr,anzeigen)
            input()
            ...
            Jahr = input('Jahr Eingeben: ')
            os.system('clear')
            Jahresverbrauch(FileListe,Verzeichnis,Auswertung,Jahr,anzeigen)
            input()
